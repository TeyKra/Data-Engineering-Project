file://<HOME>/Desktop/EFREI/M1/SM8/DATA%20ENGINEERING/Projet/Projet%20V2/Data_Engineering_M1_Project/build.sbt
### file%3A%2F%2F%2FUsers%2Fmorgan%2FDesktop%2FEFREI%2FM1%2FSM8%2FDATA%2520ENGINEERING%2FProjet%2FProjet%2520V2%2FData_Engineering_M1_Project%2Fbuild.sbt:32: error: `end of file` expected but `}` found
}
^
...
action parameters:
uri: file://<HOME>/Desktop/EFREI/M1/SM8/DATA%20ENGINEERING/Projet/Projet%20V2/Data_Engineering_M1_Project/build.sbt
text:
```scala
...
lazy val root = (project in file("."))
  .settings(
    ...
    // Ajout des dépendances de Circe pour la sérialisation et désérialisation JSON
    libraryDependencies ++= Seq(
      "io.circe" %% "circe-core" % "0.14.1",
      "io.circe" %% "circe-generic" % "0.14.1",
      "io.circe" %% "circe-parser" % "0.14.1",

      // Dépendances Kafka Streams
      "org.apache.kafka" %% "kafka-streams-scala" % "2.8.0",
      "org.apache.kafka" % "kafka-streams" % "2.8.0",

      // Inclure Kafka Clients si nécessaire pour la configuration de Kafka
      "org.apache.kafka" % "kafka-clients" % "2.8.0"
    ),

    // Option pour augmenter la mémoire allouée à SBT si nécessaire
    javaOptions in run ++= Seq("-Xmx2G", "-Xms1G")
  )
}
```
